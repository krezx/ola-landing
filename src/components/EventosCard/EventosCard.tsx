...
export const EventosCard: React.FC<EventosProps> = ({ evento }) => {
  ...
  return (
    <div className="overflow-hidden shadow-lg">
      <div 
        ...
        onClick={() => setSelectedImage(evento.imagenUrl)}
      >
        <Image
      ...
      {evento.galleryImages && evento.galleryImages.length > 0 && (
        <div className="mt-5 w-full">
          <div className="grid auto-rows-fr 
            ...
            {evento.galleryImages.map((image, index) => (
              <div 
                key={index} 
